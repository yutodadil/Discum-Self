import discum, random, requests, time, discord, asyncio, toml, httpx
...
daikyou = ["ラッキーアクションは人生に絶望する", "ラッキーアイテムはDebianOS", "ラッキーアクションは1日ずっと暇してる", "ラッキーフードはレモンティー", "ラッキーフードはオムライス", "ラッキーカラーは白", "ラッキーカラーは黄色"]

kyou = ["ラッキーカラーは凶の人にはないです絶望しててください。", "ラッキーフードは凶の人には無いです絶望しててください。", "ラッキーアイテムは凶の人には無いです今日という一日を絶望しながら生きてください。", "凶のあなたのラッキーアクションは\:chipmunk:\:mosquito:です。"]

suekiti = ["ラッキーアクションは何もなくただつまらないだけの1日を過ごす", "ラッキーアクションは水族館へ行く", "ラッキーアクションはbot作者の推し様の配信を見に行く(https://www.mirrativ.com/user/5959467 )", "ラッキーアイテムはAws", "ラッキーアイテムはGCP", "ラッキーアイテムはいちごの花", "ラッキーカラーは#BD97FF", "ラッキーカラーは#A4A4FF"]

syoukiti = ["ラッキーアイテムはWindows Server 2012 R2", "ラッキーアクションはVNC Viewerで知らないVNCサーバーへ入る", "ラッキーカラーは#50FF95", "ラッキーフードは水素水", "ラッキーフードは毛蛋", "ラッキーアクションは本を読む", "ラッキーナンバーは443", "ラッキーナンバーは80"]

kiti = ["ラッキーアイテムはUnixサーバー", "ラッキーアクションは教会へ行き自分の今までの行動を懺悔する", "ラッキーアイテムは押し売りから買った壺", "ラッキーアクションはメモ帳でコーディング", "ラッキーナンバーは22", "ラッキーナンバーは123", "ラッキーカラーは黒", "ラッキーカラーは緑"]

daikiti = ["ラッキーナンバーは22", "ラッキーナンバーは3389", "ラッキーフードはAquarius", "ラッキーフードはパン", "ラッキーアイテムはロイヤルパイソン", "ラッキーアイテムはNintendo Switchの空箱", "ラッキーアクションはOSINTを鍛える", "ラッキーアクションは仲いい人のサーバーにPentestをする", "ラッキーカラーは#99FAD5", "ラッキーカラーは#C4B7FA"]

tyuukiti = ["ラッキーナンバーは53", "ラッキーナンバーは42", "ラッキーフードは葡萄じゅーす", "ラッキーフードは地球グミ", "ラッキーアイテムはOracle", "ラッキーアイテムはSkiddie", "ラッキーアクションはebayにDDoSをする", "ラッキーアクションはAmazonで爆買いする", "ラッキーカラーは趙緑", "ラッキーカラーは赤緑色"]
...
async def join(ctx, invite):
  await ctx.message.delete()
  r = httpx.post(f'https://discord.com/api/v9/invites/{invite}',  proxies='socks5://127.0.0.1:9050', headers={
          ...
          'Authorization': __config__['bot']['alttoken'],
          ...
          'Cookie': '__dcfduid=21183630021f11edb7e89582009dfd5e; __sdcfduid=21183631021f11edb7e89582009dfd5ee4936758ec8c8a248427f80a1732a58e4e71502891b76ca0584dc6fafa653638; locale=ja-JP',
  ...
  print(r)
  if r == "<Response [200 OK]>":
      await ctx.send(f"Success Join {__config__['bot']['botname']}!!\nServer is discord.gg/{invite}")
  else:
      await ctx.send(r)

@bot2.command()
async def leave(ctx, svrid):
  await ctx.message.delete()
  r = httpx.delete(f'https://discord.com/api/v9/users/@me/guilds/{svrid}',  proxies='socks5://127.0.0.1:9050', headers={
          "Authorization": __config__['bot']['alttoken'],
          "accept": "*/*",
          "accept-language": "ja-JP",
          "Accept-Encoding": "gzip, deflate, br",
          "connection": "keep-alive",
          "cookie": f'__cfduid={os.urandom(43).hex()}; __dcfduid={os.urandom(32).hex()}; locale=ja-JP',
          "DNT": "1",
          "origin": "https://discord.com",
          "sec-fetch-dest": "empty",
          "sec-fetch-mode": "cors",
          ...
          if len(str(dt.hour)) == 1:
              if len(str(dt.minute)) == 1:
                  if len(str(dt.second)) == 1:
                      r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                              "Authorization": __config__['bot']['maintoken'],
                              "accept": "*/*",
                              "accept-language": "ja-JP",
                              "Accept-Encoding": "gzip, deflate, br",
                              "connection": "keep-alive",
                              ...
                              "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                             "X-Super-Properties": ""
                          }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/0{dt.month}/0{dt.day} 0{dt.hour}:0{dt.minute}:0{dt.second}"})
                  else:
                      r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                              "Authorization": __config__['bot']['maintoken'],
                              "accept": "*/*",
                              ...
                              "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                             "X-Super-Properties": ""
                          }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/0{dt.month}/0{dt.day} 0{dt.hour}:0{dt.minute}:{dt.second}"})
              else:
                  r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                          "Authorization": __config__['bot']['maintoken'],
                          "accept": "*/*",
                          ...
                          "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                          "X-Super-Properties": ""
                      }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/0{dt.month}/0{dt.day} 0{dt.hour}:{dt.minute}:{dt.second}"})
          else:
              r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                      "Authorization": __config__['bot']['maintoken'],
                      "accept": "*/*",
                      ...
                      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                      "X-Super-Properties": ""
                  }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/0{dt.month}/0{dt.day} {dt.hour}:{dt.minute}:{dt.second}"})
      else:
          r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                  "Authorization": __config__['bot']['maintoken'],
                  "accept": "*/*",
                  ...
                  "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                  "X-Super-Properties": ""
              }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/0{dt.month}/{dt.day} {dt.hour}:{dt.minute}:{dt.second}"})
  else:
      if len(str(dt.day)) == 1:
          if len(str(dt.hour)) == 1:
              if len(str(dt.minute)) == 1:
                  if len(str(dt.second)) == 1:
                      r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                              ...
                              "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                             "X-Super-Properties": ""
                          }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/{dt.month}/0{dt.day} 0{dt.hour}:0{dt.minute}:0{dt.second}"})
                  else:
                      r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                              "Authorization": __config__['bot']['maintoken'],
                              "accept": "*/*",
                              ...
                              "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                             "X-Super-Properties": ""
                          }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/{dt.month}/0{dt.day} 0{dt.hour}:0{dt.minute}:{dt.second}"})
              else:
                  r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                          "Authorization": __config__['bot']['maintoken'],
                          "accept": "*/*",
                          ...
                          "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                          "X-Super-Properties": ""
                      }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/{dt.month}/0{dt.day} 0{dt.hour}:{dt.minute}:{dt.second}"})
          else:
              r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                      "Authorization": __config__['bot']['maintoken'],
                      "accept": "*/*",
                      ...
                      "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                      "X-Super-Properties": ""
                  }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/{dt.month}/0{dt.day} {dt.hour}:{dt.minute}:{dt.second}"})
      else:
          r = httpx.patch(f'https://discord.com/api/v9/users/@me/profile',  proxies='socks5://127.0.0.1:9050', headers={
                  "Authorization": __config__['bot']['maintoken'],
                  "accept": "*/*",
                  ...
                  "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36",
                  "X-Super-Properties": ""
              }, json={"bio": f"{naiyou}\nLast Edit:{dt.year}/{dt.month}/{dt.day} {dt.hour}:{dt.minute}:{dt.second}"})
  print(r)
  await ctx.send(f"Change Bios, Change to {naiyou}\nCode -> {r}")
# Thanks for Probmkrnew, Its Good Idea.
# Thanks for Shiumano, You helped my code.
...
#            ttt = random.choice(result)
            ...
            bot.typingAction(message['channel_id'])
            Random = random.uniform(0, 3)
            time.sleep(Random)
            if ttt == "大吉":
                auau = random.choice(daikiti)
                bot.sendMessage(message['channel_id'], f'{ttt}のあなたの{auau}です。')
            elif ttt == "中吉":
                auau = random.choice(tyuukiti)
                bot.sendMessage(message['channel_id'], f'{ttt}のあなたの{auau}です。')
            elif ttt == "小吉":
                auau = random.choice(syoukiti)
                bot.sendMessage(message['channel_id'], f'{ttt}のあなたの{auau}です。')
            elif ttt == "吉":
                auau = random.choice(kiti)
                bot.sendMessage(message['channel_id'], f'{ttt}のあなたの{auau}です。')
            elif ttt == "末吉":
                ...
                auau = random.choice(daikyou)
                bot.sendMessage(message['channel_id'], f'{ttt}のあなたの{auau}です。')
            else:
                bot.sendMessage(message['channel_id'], f'Something Wrong...')
...
#                    start += 1
                    ...
                    bot.sendMessage(message['channel_id'], f'something wrong...\nbut You Can Reset Started Num,{trigger}selfreset')
            else:
                bot.sendMessage(message['channel_id'], 'You Not Allow Run This Commands.\n**403 Forbidden**')
        elif message['content'] == f'{trigger}selfreset':
            if message['author']['username'] + "#" + message['author']['discriminator'] == f"{__config__['bot']['owner']}":
                if start == 0:
                    bot.sendMessage(message['channel_id'], 'Selfbot is Not Started!')
                else:
                    bot2.close()
                    bot.sendMessage(message['channel_id'], 'OK, will reset it.')
                    start = 0
                    time.sleep(1)
                    bot.sendMessage(message['channel_id'], 'Reset Done.')
            else:
                bot.sendMessage(message['channel_id'], 'You Not Allow Run This Commands.\n**403 Forbidden**')
